...
return [
    ...
    */
    ...
    "unique"           => ":attribute از قبل وجود داشته است.",
    'uploaded'         => 'فیلد :attribute به درستی اپلود نشد.',
    "url"              => "فرمت آدرس :attribute اشتباه است.",
    'uuid'             => ':attribute باید یک فرمت درست UUID باشد.',
    'wallet_address' => 'آدرس به درستی وارد نشده است.',


    'pass' => [
        'mixed_case' => ':attribute باید حدااقل یکی از حروف بزرگ و کوچک را داشته باشد.',
        'letters' => ':attribute باید حداقل دارای یک حرف لاتین باشد.',
        'symbols' => ':attribute باید حداقل دارای یک علامت باشد.',
        'numbers' => ':attribute باید خداقل دارای یک عدد باشد.',
        'uncompromised' => 'The given :attribute has appeared in a data leak. Please choose a different :attribute.',
    ],
    'activate' =>':attribute هنوز فعال نیست.',
    'activated' =>':attribute هنوز فعال نشده است.',
    'step' => 'حداقل گام برای :attribute باید بیشتر از :min باشد.',
    'status' => ':attribute باید برابر :status باشد.',
    ...
    */
    'attributes' => [
		...
		"fullname" => "نام کامل",
        "amount" => 'مقدار',
        "password_old" => 'رمز عبور پیشین',
        'wallet_address' => 'آدرس کیف پول',
        'crypto_network_id' => 'شبکه',
        'CryptoNetwork' => 'نوع شبکه',
        'code' => 'کد',
        'order' => 'درخواست',
